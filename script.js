...
const PRODUTOS = [
    { id: 1, cat: "Medicamentos", nome: "Buscopan Duo", preco: 28.00, imagem: "./buscopan01.webp", bula: "Para alívio de cólicas abdominais." },
    { id: 2, cat: "Higiene", nome: "Shampoo Neutro", preco: 22.00, imagem: "./shampo02.png", bula: "Uso diário para limpeza profunda." },
    { id: 3, cat: "Medicamentos", nome: "Dipirona 500mg", preco: 12.50, imagem:"./dipirona03.png", bula: "Analgésico e antitérmico para febre." },
    { id: 4, cat: "Bem-Estar", nome: "Preservativo 3un", preco: 14.00, imagem: "./pre04.png", bula: "Segurança e proteção." },
    { id: 5, cat: "Higiene", nome: "Sabonete Dove", preco: 5.50, imagem: "./sabonete05.png", bula: "Limpeza com hidratação para pele." },
    { id: 6, cat: "Medicamentos", nome: "Vitamina C 1g", preco: 19.90, imagem: "./vit06.png", bula: "Reforço da imunidade, gripe." },
    { id: 7, cat: "Bem-Estar", nome: "Repelente Off", preco: 35.00, imagem: "./repe07.png", bula: "Proteção contra insetos e mosquitos." },
    { id: 8, cat: "Higiene", nome: "Lenço Umedecido", preco: 15.00, imagem: "./leco08.png", bula: "Limpeza suave da pele." },
    { id: 9, cat: "Medicamentos", nome: "Paracetamol", preco: 10.00, imagem: "./para09.png", bula: "Para febre e dor de cabeça." },
    { id: 10, cat: "Higiene", nome: "Fio Dental", preco: 8.50, imagem: "./fio10.png", bula: "Limpeza entre os dentes." }
];
